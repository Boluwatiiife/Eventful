      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 mb-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2.5 border border-[rgb(var(--border-primary))] rounded-xl text-sm
                focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none w-full sm:w-64
          ...
          {user?.role === "CREATOR" && (
            <Link
              to="/events/create"
              className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-green-600 to-black-600
                text-white text-sm font-medium rounded-xl hover:from-orange-700 hover:to-pink-700
      ...
      {loading ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3, 4, 5, 6].map((n) => (
            <div
              key={n}
              className="glass border border-[rgb(var(--border-primary))] rounded-2xl overflow-hidden"
            >
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {events.map((event) => {
              ...
              const almostSoldOut =
                (event._count?.tickets || 0) / event.capacity > 0.8;
              ...
              return (
                ...
                >
                  {/* Event Image/Banner */}
                  <div className="relative h-48 bg-gradient-to-br from-green-500 via-orange-600 to-black-600 overflow-hidden">
                  ...
                  {/* Event Info */}
                  <div className="p-5">
                    <h3 className="font-semibold text-lg text-[rgb(var(--text-primary))] group-hover:text-yellow-600 dark:group-hover:text-green-400 transition-colors mb-2 line-clamp-2">
                      {event.title}
                    </h3>
                    ...
                    <div className="space-y-2.5">
                      <div className="flex items-center gap-2 text-sm text-[rgb(var(--text-secondary))]">
                        <HiOutlineCalendar className="w-4 h-4 text-indigo-500 flex-shrink-0" />
                        <span>
                          {format(new Date(event.date), "MMM d, yyyy • h:mm a")}
                        </span>
                      </div>
                      <div className="flex items-center gap-2 text-sm text-[rgb(var(--text-secondary))]">
                        <HiOutlineLocationMarker className="w-4 h-4 text-indigo-500 flex-shrink-0" />
                      ...
                      <div className="flex items-center justify-between pt-3 border-t border-[rgb(var(--border-primary))]">
                        ...
                        <div className="flex items-center gap-1 font-semibold text-green-600 dark:text-pink-400">
                      ...
                      <div className="mt-2">
                        <div className="h-1.5 bg-[rgb(var(--bg-tertiary))] rounded-full overflow-hidden">
                          <div
                            className="h-full bg-gradient-to-r from-green-500 to-yellow-600 transition-all duration-500"
                            style={{
                    ...
                    {event.creator && (
                      <div className="flex items-center gap-2 mt-4 pt-4 border-t border-[rgb(var(--border-primary))]">
                        <div className="w-7 h-7 rounded-full bg-gradient-to-br from-pink-500 to-black-600 flex items-center justify-center text-white text-xs font-semibold">
                  ...
                  return (
                    <button
                      ...
                      className={`w-10 h-10 rounded-lg text-sm font-medium transition-colors ${
                        page === pageNum
                          ? "bg-gradient-to-r from-green-600 to-orange-600 text-white shadow-md"
