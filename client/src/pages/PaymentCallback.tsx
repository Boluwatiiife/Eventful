    ...
    const verifyPayment = async () => {
      ...
      try {
        ...
        if (
          ...
          response.data.data.payment.status === "SUCCESS"
        ) {
          setStatus("success");
      ...
      <div className="max-w-md w-full glass border border-[rgb(var(--border-primary))] rounded-2xl shadow-lg p-8">
        {status === "verifying" && (
          <div className="text-center">
            ...
            <h2 className="mt-4 text-2xl font-bold text-[rgb(var(--text-primary))]">
              Verifying Payment
            </h2>
        ...
        {status === "success" && ticket && (
          <div className="text-center">
            ...
            <h2 className="mt-4 text-3xl font-bold text-[rgb(var(--text-primary))]">
              Congratulations! 🎉
            </h2>
            ...
            <div className="mt-6 p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-700 rounded-lg text-left">
              ...
              <div className="mt-3 pt-3 border-t border-green-200 dark:border-green-700">
                <p className="text-sm text-green-700 dark:text-green-300 font-medium">
                  💡 Your ticket is ready! Check your email for confirmation and
                  save your QR code.
                </p>
              </div>
            </div>
