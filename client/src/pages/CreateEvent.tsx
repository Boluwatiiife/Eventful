        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none transition text-gray-900"
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-2.5 border border-red-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-orange-500 outline-none transition resize-none text-gray-900"
          ...
          <div className="border-t border-gray-200 pt-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, defaultReminderValue: e.target.value })
                }
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition text-gray-900"
                placeholder="e.g. 1"
              />
              <select
                ...
                onChange={(e) =>
                  setForm({ ...form, defaultReminderUnit: e.target.value })
                }
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition text-gray-900"
              >
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 py-2.5 bg-green-600 text-white rounded-lg font-medium hover:bg-purple-700 disabled:opacity-50 transition"
            >
