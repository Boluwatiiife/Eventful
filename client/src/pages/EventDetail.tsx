      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="relative overflow-hidden rounded-2xl h-64 lg:h-80 group">
            <div className="absolute inset-0 bg-gradient-to-br from-green-500 via-yellow-600 to-black-600 flex items-center justify-center">
            ...
            <div className="glass border border-[rgb(var(--border-primary))] rounded-xl p-5 space-y-3 animate-fade-in">
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="p-3 rounded-lg bg-sky-100 dark:bg-sky-900/30 text-sky-600 dark:text-sky-400 hover:scale-110 transition-transform"
                >
                  <FaTwitter size={18} />
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3 rounded-lg bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-white-400 hover:scale-110 transition-transform"
                >
                  <FaFacebook size={18} />
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3 rounded-lg bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 hover:scale-110 transition-transform"
                >
                  <FaLinkedin size={18} />
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3 rounded-lg bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 hover:scale-110 transition-transform"
                >
                  <FaWhatsapp size={18} />
                </a>
                <a
                  href={shareLinks.email}
                  className="p-3 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:scale-110 transition-transform"
                >
                  <FaEnvelope size={18} />
                </a>
              </div>
          ...
          <div className="hidden lg:block glass border border-[rgb(var(--border-primary))] rounded-xl p-6 space-y-4">
            <div className="flex items-start gap-3">
              <HiOutlineCalendar className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
              <div>
                <p className="text-xs text-[rgb(var(--text-tertiary))] uppercase tracking-wide">
                  Date & Time
                </p>
            ...
            <div className="flex items-start gap-3">
              <HiOutlineLocationMarker className="w-5 h-5 text-yellow-500 mt-0.5 flex-shrink-0" />
              <div>
                <p className="text-xs text-[rgb(var(--text-tertiary))] uppercase tracking-wide">
                  Location
                </p>
            ...
            <div className="flex items-start gap-3">
              <HiOutlineUsers className="w-5 h-5 text-pink-500 mt-0.5 flex-shrink-0" />
              <div>
                <p className="text-xs text-[rgb(var(--text-tertiary))] uppercase tracking-wide">
                  Availability
                </p>
                ...
                <div className="mt-2 h-2 bg-[rgb(var(--bg-tertiary))] rounded-full overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${((event._count?.tickets || 0) / event.capacity) * 100}%`,
                    }}
                  />
                </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="glass border border-[rgb(var(--border-primary))] rounded-xl p-6 lg:p-8">
            ...
            {event.creator && (
              <div className="flex items-center gap-3 text-sm">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-green-500 to-black-600 flex items-center justify-center text-white font-semibold">
          ...
          <div className="lg:hidden grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="glass border border-[rgb(var(--border-primary))] rounded-xl p-4 text-center">
              ...
              <p className="text-xs text-[rgb(var(--text-tertiary))] uppercase">
                Date
              </p>
              <p className="text-sm font-medium text-[rgb(var(--text-primary))] mt-1">
            ...
            <div className="glass border border-[rgb(var(--border-primary))] rounded-xl p-4 text-center">
              <HiOutlineLocationMarker className="w-6 h-6 text-green-500 mx-auto mb-2" />
              <p className="text-xs text-[rgb(var(--text-tertiary))] uppercase">
                Location
              </p>
              <p className="text-sm font-medium text-[rgb(var(--text-primary))] mt-1 truncate">
                {event.location}
              </p>
            </div>
            <div className="glass border border-[rgb(var(--border-primary))] rounded-xl p-4 text-center">
              <HiOutlineUsers className="w-6 h-6 text-green-500 mx-auto mb-2" />
              <p className="text-xs text-[rgb(var(--text-tertiary))] uppercase">
                Capacity
              </p>
              <p className="text-sm font-medium text-[rgb(var(--text-primary))] mt-1">
          ...
          {!isCreator && (
            <div className="glass border border-[rgb(var(--border-primary))] rounded-xl p-6 lg:p-8 bg-gradient-to-br from-indigo-50/50 to-purple-50/50 dark:from-indigo-950/20 dark:to-purple-950/20">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                  <p className="text-sm text-green-600 dark:text-green-400 font-medium uppercase tracking-wide mb-1">
                    Ticket Price
                  </p>
                ...
                <button
                  ...
                  className="px-8 py-3.5 bg-gradient-to-r from-orange-600 to-pink-600 text-white rounded-xl font-semibold
                    hover:from-yellow-700 hover:to-green-700 disabled:opacity-50 disabled:cursor-not-allowed
