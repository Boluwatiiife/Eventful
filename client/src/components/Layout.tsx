          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <div className="hidden md:flex ml-10 space-x-4">
                <Link
                  to="/events"
                  className="flex items-center gap-1 px-3 py-2 text-sm text-[rgb(var(--text-primary))] hover:text-indigo-600 dark:hover:text-indigo-400 rounded-md hover:bg-[rgb(var(--bg-secondary))] transition-colors"
                >
                    ...
                    {user.role === "CREATOR" && (
                      <>
                        ...
                        <Link
                          ...
                          className="flex items-center gap-1 px-3 py-2 text-sm text-[rgb(var(--text-primary))] hover:text-indigo-600 dark:hover:text-indigo-400 rounded-md hover:bg-[rgb(var(--bg-secondary))] transition-colors"
                        >
                          <HiOutlineQrcode className="w-4 h-4" /> Verify Your
                          Ticket
                        </Link>
                      </>
                    )}
              ...
              {user ? (
                <>
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 text-sm text-gray-700 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-400"
                  >
            ...
            {user ? (
              <>
                ...
                <button
                  ...
                  className="block w-full text-left px-3 py-2 text-sm text-red-600 hover:bg-gray-50 rounded-md"
                >
                  Logout
                </button>
              </>
              ...
              <>
                ...
                <Link
                  to="/register"
                  onClick={() => setMenuOpen(false)}
                  className="block px-3 py-2 text-sm text-indigo-600 hover:bg-gray-50 rounded-md"
                >
                  Register
                </Link>
              </>
